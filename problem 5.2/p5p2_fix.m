...
% Generate wave disturbance with values obtained by comparing
% generated data with the supplied wave.mat
Kw_wavegen = 0.4224;
lambda_wavegen = 0.0936;
w0_wavegen = 0.7823;

sim('p5p2_model_fix.slx');

% Compute Power Spectral Density for wave_fix.mat
load wave_fix.mat;
...
hold on;
loglog(w, sxx);
title('Analytical and measured PSD for the corrected wave influence');
